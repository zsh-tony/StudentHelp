...
- (void)addDock
{
    ...
    dock.itemClickBlock = ^(int index){
        ...
        NSLog(@"index--%d",index);
        if (index != 4) {
            [main selectedControllerAtIndex:index];
        }else{
            ...
            for (int i=0; i<kCount; i++) {
                if (i==0) {
                    [main addHelpBtnWithIndex:i name:@"取快递"];
                }else if(i == 1){
                    [main addHelpBtnWithIndex:i name:@"食堂带饭"];
                }else if(i == 2){
                    [main addHelpBtnWithIndex:i name:@"校外带饭"];
                }else if(i == 3){
                    [main addHelpBtnWithIndex:i name:@"替上课"];
                }else if(i == 4){
                    [main addHelpBtnWithIndex:i name:@"去超市"];
                }else if(i == 5){
                    [main addHelpBtnWithIndex:i name:@"自定义"];
                }else if(i == 6){
                    [main addHelpBtnWithIndex:i name:@"打水"];
                }else
                {
                    [main addHelpBtnWithIndex:i name:@"更多"];
                }
            }
