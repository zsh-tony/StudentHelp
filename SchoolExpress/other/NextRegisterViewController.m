...
//    UILabel *noteCode = [[UILabel alloc]initWithFrame:CGRectMake(kItemWidth-kTimerWidth,keywordText.frame.origin.y , kTextWidth, kLabelHeight)];
//    noteCode.text = @"由4-20位的数字或字母组成";
//    noteCode.font = [UIFont systemFontOfSize:12];
//    noteCode.textColor = [UIColor lightGrayColor];
//    [self.view addSubview:noteCode];
