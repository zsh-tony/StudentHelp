...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        __weak DetailAccountCell *weakSelf = self;
        _setDayTableView = ^(CGFloat tableViewHeight,NSArray *incomePayArray){
            weakSelf.dayTableView = [[UITableView alloc]initWithFrame:CGRectMake(40, 0, 270, tableViewHeight)style:UITableViewStylePlain];
            [weakSelf.dayTableView setScrollEnabled:NO];
            weakSelf.dayTableView.delegate = weakSelf;
            weakSelf.dayTableView.dataSource = weakSelf;
            weakSelf.dayTableView.separatorStyle = UITableViewCellSeparatorStyleSingleLine;
            _dataArray = incomePayArray;
            [weakSelf.contentView addSubview:weakSelf.dayTableView];
...
//            [self.dayTableView addSubview:widthSeperator];
            ...
            [weakSelf.dayTableView addSubview:heightSeperator];
        };
