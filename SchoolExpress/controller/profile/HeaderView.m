...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //CGRectMake(320 - kTotalTextWidth - kWidthMargin , _totalLabel.frame.origin.y+_totalLabel.frame.size.height + kHeightMargin, kTotalTextWidth, self.frame.size.height - _totalLabel.frame.origin.y-_totalLabel.frame.size.height - kHeightMargin*2)
        //_totalLabel.frame.origin.y+_totalLabel.frame.size.height + kHeightMargin
...
//#pragma mark 设置UIImageView的位置和尺寸
//- (CGRect)imageRectForContentRect:(CGRect)contentRect
//{
//    return CGRectMake(4, 4, 20  , 20);
//}
//- (CGRect)titleRectForContentRect:(CGRect)contentRect
//{
//    return CGRectMake(30, -10, 150, 50);
//}
////-(CGRect)backgroundRectForBounds:(CGRect)bounds
//{
//    return CGRectMake(25, 25, 80, 2);
//}
@end
