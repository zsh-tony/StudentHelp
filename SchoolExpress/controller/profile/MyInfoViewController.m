    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            selectsch.selectmidSchBlock = ^(int selmidsch,NSString *display){
                [selectsch.navigationController popViewControllerAnimated:YES];
...
//        if (buttonIndex == 1) {
//            changePhoneAlert2 = [[UIAlertView alloc]initWithTitle:nil message:@"13259807852号码还在使用中可以接收到短信吗?" delegate:self cancelButtonTitle:@"不能" otherButtonTitles:@"能", nil];
//            [changePhoneAlert2 show];
//        }
//    }
    else{
