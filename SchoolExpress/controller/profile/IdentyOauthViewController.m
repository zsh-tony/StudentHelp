    ...
    if (indexPath.section == 0) {
        ...
        uploadPhotoCell.uploadIDFacePhoto = ^(){
            ...
            if ([UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]){
                IDFaceImagePicker = [[UIImagePickerController alloc] init];
                IDFaceImagePicker.delegate = self;
                IDFaceImagePicker.allowsEditing = YES;
                IDFaceImagePicker.sourceType = UIImagePickerControllerSourceTypeCamera;
                
                [self presentViewController:IDFaceImagePicker animated:YES completion:nil];
            }else{
                NSLog(@"没有摄像头");
            }
        ...
        uploadPhotoCell.uploadIDBackPhoto = ^(){
            ...
            if ([UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]){
                IDBackImagePicker = [[UIImagePickerController alloc] init];
                IDBackImagePicker.delegate = self;
                IDBackImagePicker.allowsEditing = YES;
                IDBackImagePicker.sourceType = UIImagePickerControllerSourceTypeCamera;
                
                [self presentViewController:IDBackImagePicker animated:YES completion:nil];
            }else{
                NSLog(@"没有摄像头");
            }
        ...
        uploadPhotoCell.uploadStudentIDPhoto = ^(){
            ...
            if ([UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]){
                studentIDImagePicker = [[UIImagePickerController alloc] init];
                studentIDImagePicker.delegate = self;
                studentIDImagePicker.allowsEditing = YES;
                studentIDImagePicker.sourceType = UIImagePickerControllerSourceTypeCamera;
                
                [self presentViewController:studentIDImagePicker animated:YES completion:nil];
            }else{
                NSLog(@"没有摄像头");
            }
