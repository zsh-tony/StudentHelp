...
//               classInfoCell = [tableView                               dequeueReusableCellWithIdentifier:CellIdentifier4];
//               if (classInfoCell == nil) {
//                   classInfoCell = [[UIBTextViewCell alloc]initWithStyle:UITableViewCellStyleDefault      reuseIdentifier:CellIdentifier4] ;
//               }
//               classInfoCell.placeholder.text = @"具体的要求可以提，比如口味方面不要辣椒";
//               classInfoCell.titleLabel.text = @"美食详情:";
//               classInfoCell.contentText.returnKeyType = UIReturnKeyNext;
//               classInfoCell.returnKey = ^(UITextView *textView){
//                
//                   [textView resignFirstResponder];
//                   
//                   
//               };
//               classInfoCell.keyboardHeight = ^{
//                   frameHeight = 90;
//               };
//               classInfoCell.selectionStyle = UITableViewCellSelectionStyleNone;
